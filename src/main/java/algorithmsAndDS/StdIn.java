...
/**
 * <i>Standard input</i>. This class provides methods for reading strings and numbers from standard input. See <a
 * href="http://introcs.cs.princeton.edu/15inout">Section 1.5</a> of <i>Introduction to Programming in Java: An
 * Interdisciplinary Approach</i> by Robert Sedgewick and Kevin Wayne.
 * <p>
 * See the technical information in the documentation of the {@link In} class, which applies to this class as well.
 */
public final class StdIn {
    ...
    /***
     * begin: section (2 of 2) of code duplicated from In to StdIn, with all methods changed from "public" to
     * "public static"
     ***/
    ...
    /**
     * Is the input empty (including whitespace)? Use this to know whether the next call to {@link #readChar()} will
     * succeed.
     * <p>
